...
class DatasetPlus:
    def __init__(self, df,  tokenizer, max_len, batch_size, num_workers, column_sequence1, column_sequence2=None, column_target=None):
    ...
    class DatasetRow(data.Dataset):
        def __init__(self, tokenizer, max_len, sequence1, sequence2=None, targets=None):
